...
public enum EraMode
{
    ...
    Huangdi = 1,
    /// <summary>大清宣統紀年〔惡搞〕：清宣統元年為西元 1909 年，西元年 − 1908。</summary>
    Xuantong = 2,
    /// <summary>民國紀年：中華民國元年為西元 1912 年，西元年 − 1911。</summary>
    Minguo = 3,
    /// <summary>大漢紀年：以漢朝成立（西元前 202 年）為元年，西元年 + 202。</summary>
    Dahan = 4,
...
public static class EraCalendar
{
    ...
    public static readonly string[] Names = { "西元紀年", "中華黃帝紀元", "大清宣統紀年〔惡搞〕", "民國紀年", "大漢紀年", "哆啦A夢紀元〔惡搞〕" };
    ...
    public static string Format(DateTime t, EraMode mode) => mode switch
    {
        ...
        EraMode.Xuantong => $"大清宣統 {t.Year - 1908} 年 {t.Month} 月 {t.Day} 日  {t:HH:mm:ss}",
        EraMode.Minguo   => $"民國 {t.Year - 1911} 年 {t.Month} 月 {t.Day} 日  {t:HH:mm:ss}",
        EraMode.Dahan    => $"大漢 {t.Year + 202} 年 {t.Month} 月 {t.Day} 日  {t:HH:mm:ss}",
