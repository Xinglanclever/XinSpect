...
public static class PageRegistry
{
    ...
    [
        ...
        new()
        {
            ...
            Keywords = ["cpu", "processor", "核心", "執行緒", "快取", "拓樸", "腳座", "腳位", "socket", "lga", "pga", "針腳"],
        },
        new()
        {
            Key = "npu", Title = "NPU 檢測", Group = GHardware,
        ...
        new()
        {
            ...
            Keywords = ["memory", "ram", "dram", "spd", "時序", "記憶體", "dimm", "插槽", "缺口", "ddr4", "ddr5"],
        },
        new()
        {
            ...
            Keywords = ["mainboard", "motherboard", "bios", "晶片組", "主機板", "chipset", "南橋", "北橋", "pch", "pcie", "供電", "vrm", "分析"],
        },
        new()
        {
            ...
            Keywords = ["gpu", "vga", "顯卡", "顯示卡", "vram", "色域", "顯卡分析", "tflops", "分析"],
        },
        new()
        {
            ...
            Hint = "磁碟容量、健康度與讀寫活動",
            Keywords = ["disk", "ssd", "hdd", "nvme", "smart", "磁碟", "硬碟", "sata", "m.2", "u.2", "esata", "介面"],
        },
        new()
        {
        ...
        new()
        {
            Key = "computechart", Title = "算力圖", Group = GMonitor,
        ...
        new()
        {
            Key = "gpurendertest", Title = "繪圖管線測試", Group = GMonitor,
        ...
        new()
        {
            Key = "driveranalysis", Title = "進階驅動分析", Group = GSystem,
    ...
    [
        ...
        new()
        {
            Key = "bootrepair", Title = "系統引導修復", Group = GSystem,
        ...
        new()
        {
            ...
            Key = "hwtest", Title = "硬體檢測", Group = GSystem,
